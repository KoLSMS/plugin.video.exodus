        ...
        try:
            ...
            if not str(url).startswith('http'):
                ...
                if 'tvshowtitle' in data:
                    url = '%s/%s-episode-%01d/' % (self.base_link, cleantitle.geturl(data['tvshowtitle']), int(data['episode']))
                else:
                    url = '%s/%s-%01d/' % (self.base_link, cleantitle.geturl(data['title']), int(data['year']))
